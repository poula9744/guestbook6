...
<body>
	<form action="${pageContext.request.contextPath}/insert" method="get">
		<table border="1" width="540px">
			<tr>
				<td>이름</td><td><input type="text" name="name" value="${guestVo.name}"></td>
				<td>비밀번호</td><td><input type="password" name="password" value="${guestVo.password}"></td>
			</tr>
			<tr>
				<td colspan="4"><textarea cols="72" rows="5" name="content">${guestVo.content}</textarea></td>
			</tr>
			<tr>
